...
export const BENEFICIAIRES: Beneficiaire[] = [
  {
    ...
    testimonial: "Grâce à l'ONG, j'ai pu terminer mes études et trouver un emploi stable.",
  },
  {
    id: 2,
    name: "Jean Mbeki",
    ...
    testimonial: "Les formations agricoles m'ont permis de doubler ma production et de mieux nourrir ma famille.",
  },
  {
    id: 3,
    name: "Fatou Sow",
    role: "Mère de famille",
    image: "/placeholder.svg?height=300&width=300&text=Fatou",
    testimonial: "Le centre de santé dans notre village a sauvé la vie de mon enfant.",
  },
  {
    id: 4,
    name: "Ibrahim Koné",
    ...
    testimonial: "Le microcrédit m'a permis de lancer mon entreprise et d'employer cinq personnes de ma communauté.",
  },
  {
    id: 5,
    name: "Aïcha Diop",
    role: "Artisane",
    image: "/placeholder.svg?height=300&width=300&text=Aicha",
    testimonial: "La coopérative féminine a changé ma vie et celle de nombreuses femmes de mon village.",
  },
  {
    id: 6,
    name: "Thomas Ndiaye",
    ...
    testimonial: "La bourse d'études m'a permis de poursuivre mon rêve de devenir médecin.",
  },
]
...
export const HISTOIRE_SECTIONS: HistoireSection[] = [
  {
    ...
    title: "Nos débuts",
    content: [
      "[Votre contenu ici] Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl.",
  ...
  },
  {
    ...
    content: [
      "[Votre contenu ici] Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl.",
      "Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl.",
    ],
...
export const ACTIONS: Action[] = [
  {
    id: 1,
    title: "Action 1",
    description: "[Votre contenu ici] Description de l'action et de son impact sur la communauté et les bénéficiaires.",
